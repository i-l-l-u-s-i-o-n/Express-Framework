...
// Cookie Parser is automatically included as we generated this project using 'express generated'.
// But we need to provide a secret key to digitally sign the cookie. 
app.use(cookieParser('12312-23123-12321-23112'));

// Signed cookies are included in the 'req.signedCookies' while normal cookies can be accessed using 'req.cookies'
...
function auth(req, res, next) {
    ...
    // Just checking what info is coming from the client as cookie.
    ...
    if (!req.signedCookies.user) {
        ...
        // This means the cookie doesn't has user field i.e. user is not authenticated.
        ...
        if (username === 'admin' && password === 'password') {
            ...
            // So this is the best place we set up our cookie before going to next set of middleware.

            res.cookie('user', 'admin', { signed: true });
            // 3 parameters of res.cookie is name, value and options. Here 'user' is the key or property on cookie object, 'admin' is the value. and signed:true means we want cookie to be signed using secret key!
